function [ coord, label, EPSG ] = getUnlabeledCoord( path )
% Function getUnlabeledCoord get the coordinate of unlabel data.
%       Input:
...
%               -       label                   - unlabel code 0, [N x 1] numpy array. N: number of labels
