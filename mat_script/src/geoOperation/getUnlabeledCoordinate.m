function [ imCoord, label ] = getUnlabeledCoordinate( labelDir,se1Dir,se2Dir,patchSize )
%This function loads the real world coordinates and image coordinates of
%unlabeled data that exists in both sentinel-1 and sentinel-2 data
%       Input:
...
[ coord, label, EPSG ] = getUnlabeledCoord( labelDir );
