function [ imCoord, label ] = getROICoordinate( labelDir,se1Dir,se2Dir,patchSize )
...
%
%       Output:
%               -       imCoord                 - label coordiantes, [N x 6] numpy array. 
%               -       label                   - code of labels, [N x 1] numpy array. N: number of labels
% 
% imCoord is a [N x 6] numpy array
%       1st column               UTM X
%       2nd column               UTM Y
...
[ coord, label, EPSG ] = getROICoord( labelDir );
