function [ M,oa,pa,ua,kappa ] = clusteringConfusionMatrix_mul2one( label, claMap )
%This function calculates confusion matrix for clustering results allow 
%multiple clusters corresponding to one class in ground truth
...
processed = zeros(1,length(cla_clusters));
