function [ label, cluMap,labelColor ] = clusteringMapShow_one2one( label, cluMap )
...
labelColor=label2color(label, 'flevoland');
figure,imshow(labelColor);
cluColor=label2color(cluMap.*(label~=0), 'flevoland');
figure,imshow(cluColor);
cluColor=label2color(cluMap, 'flevoland');
figure,imshow(cluColor);
